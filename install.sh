...
# if values are not passed in, default to values are set.
VERSION=2.4.1
CA_VERSION=1.5.2
DOCKER=true
BINARIES=true
...
printHelp() {
    echo "Usage: install.sh [version [ca_version]] [options]"
    echo
    echo "options:"
    echo "-h : this help"
    ...
    echo
    echo "e.g. install.sh 2.4.1 1.5.2"
...
# Parse command line args pull out
